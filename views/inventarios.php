        ...
        <div class="container">
            <div class="row">
                <div class="table-responsive">
                    <table class="table" id="tabla-inventario" width="100%">
                        <thead>
                            <tr>
                                <th>FACTURA</th>
                                <th>MATERIA PRIMA</th>
                ...
                <form class="was-validated" method="post" id="form-create-factura" enctype="multipart/form-data" autocomplete="off">
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-sm-11">
                                <input id="create_correlativo" type="number" name="create_correlativo"
                                    class="validate form-control" placeholder="Correlativo" required>
                            </div>
                        </div>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-sm-11">
                            <select id="create_proveedor" name="create_proveedor" class="form-control">
                                </select>
                            </div>
                        </div>
                    </div>
