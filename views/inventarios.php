...
<div class="main-content">
        ...
        <div class="row">
            <div class="container">
                <div class="alert alert-primary" role="alert" widht="80%">
                    <!-- Tabla de referencia de estado de facturas -->
                    <table class="display">
                        <thead>
                            <tr>
    ...
    <!-- Botones para agregar factura o agregar productos a una factura -->
    <div class="container">
        <div class="row">
...
<!-- Modal para ver detalle de facturas -->
...
<!-- Modal de agregar productos a una factura -->
...
<!-- Modal de modificar productos de una factura -->
