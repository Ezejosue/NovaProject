        ...
        <div class="col-lg-12">
            <div class="au-card m-b-30">
                <div class="container">
                    ...
                    <a class="btn btn-primary" href="../core/report/reporte1.php" target="_blank"
                        role="button">Platillos por categoría</a>
                    <a class="btn btn-primary" href="../core/report/reporte2.php" target="_blank" role="button">Pedidos
                        por fecha</a>
                    <a class="btn btn-primary" href="../core/report/reporte3.php" target="_blank" role="button">Materia
                        prima por categoría</a>
                    <a class="btn btn-primary" href="../core/report/reporte4.php" target="_blank" role="button">Ganancia
                        por platillo</a>
                    <a class="btn btn-primary" href="../core/report/reporte5.php" target="_blank" role="button">Ganancia
                        por categoría</a>
                </div>
            </div>
        </div>
