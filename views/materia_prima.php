                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-sm-11">
                                    ...
                                    <input id="create_nombre_materia" type="text" name="create_nombre_materia" class="validate form-control" placeholder="Nombre de materia prima" required>
                                </div>
                            </div>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-sm-11">
                                    ...
                                    <textarea placeholder="Descripción" class="form-control" id="create_descripcion_materia" name="create_descripcion_materia" for="create_descripcion_materia"
                                        rows="3"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-sm-11">
                                    ...
                                    <input id="nombre_materia" type="text" name="nombre_materia" class="validate form-control" placeholder="Nombre de materia prima" required>
                                </div>
                            </div>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-sm-11">
                                    ...
                                    <textarea placeholder="Descripción" class="form-control" id="descripcion_materia" name="descripcion_materia" for="descripcion_materia"
                                        rows="3"></textarea>
                                </div>
                            </div>
                        </div>
