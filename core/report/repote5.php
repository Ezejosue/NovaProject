...
$pdf->Cell(125,10, utf8_decode('Nombre'),1,0,'C', true);
$pdf->Cell(25,10, utf8_decode('Apellido'),1,0,'C', true);
$pdf->Cell(25,10, utf8_decode('Teléfono'),1,0,'C', true);
$pdf->Cell(25,10, utf8_decode('Genero'),1,0,'C', true);
$pdf->Cell(25,10, utf8_decode('Dirección'),1,0,'C', true);
$pdf->Ln();
...
foreach($data as $datos){
        ...
        $pdf->Cell(125,10, utf8_decode($datos['nombre_empleado']),1,0,'C');
        $pdf->Cell(25,10, utf8_decode($datos['apellido_empleado']),1,0,'C');
        $pdf->Cell(25,10, utf8_decode($datos['telefono']),1,0,'C');
        $pdf->Cell(25,10, utf8_decode($datos['genero']),1,0,'C');
        $pdf->Cell(25,10, utf8_decode($datos['direccion']),1,0,'C');
        //saldo de linea
        $pdf->Ln();
}
